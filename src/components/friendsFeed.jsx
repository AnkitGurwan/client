        ...
        <div className=' bg-white rounded-lg'>
            <div className='h-20 flex items-center px-6'>
                ...
                <div className='ml-3' onClick={friendhandler}>
                    {check?
                    <span class="material-symbols-outlined text-blue-600 text-lg bg-white h-7 w-7 flex items-center justify-center rounded-full hover:bg-blue-200 cursor-pointer">
                        group_add
                    </span>:""
                 }
                </div>
